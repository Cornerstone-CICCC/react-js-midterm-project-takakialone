        ...
        <aside className="col-span-12 lg:col-span-4 sticky top-32">
          <div className="glass-card p-md border-primary-container/20 shadow-[0_0_30px_rgba(42,229,0,0.05)]">
            ...
            <div className="space-y-sm font-label-mono text-sm">
              ...
              <div className="flex justify-between text-on-surface-variant">
                <span>ENCRYPTION TAX:</span>
                <span>0.0001 BTC</span>
              </div>
              <div className="flex justify-between text-secondary pt-sm border-t border-outline-variant/20">
                <span className="font-bold">TOTAL ESTIMATE:</span>
                <span className="text-lg font-black">0.0240 BTC</span>
              </div>
              <div className="text-right text-on-surface-variant text-xs">
                ≈ $1,529.20 USD
              </div>
            </div>
            <div className="mt-md space-y-sm">
              <button className="w-full py-md bg-primary-container text-on-primary font-headline-md text-headline-md uppercase tracking-tighter hover:bg-primary-fixed-dim transition-all active:scale-95 duration-200 neon-glow-primary">
                PROCEED TO FAKE CHECKOUT
              </button>
              <button className="w-full py-sm border border-secondary text-secondary font-label-mono hover:bg-secondary/10 transition-colors uppercase">
