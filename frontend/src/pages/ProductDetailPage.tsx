      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-md mt-xl">
        ...
        <div className="md:col-span-1 bg-error-container/10 p-md border border-error/20 rounded-xl">
          ...
          <p className="text-xs font-code-sm text-error/80 leading-relaxed uppercase">
            THIS PRODUCT IS FOR EXTERNAL RESEARCH ONLY. DO NOT CONSUME NEAR OPEN
            FLAMES OR SENTIENT AI. SHADOWCART IS NOT RESPONSIBLE FOR ACCIDENTAL
            HIBERNATION, SPONTANEOUS TELEPORTATION, OR LOSS OF CRYPTO ASSETS
            DURING SLEEP. USE AT YOUR OWN PERIL.
          </p>
